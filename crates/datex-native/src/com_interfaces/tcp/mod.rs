...
mod tests {
    ...
    use crate::com_interfaces::{
        tcp::{
            tcp_client::TCPClientInterfaceSetupDataNative,
            tcp_server::TCPServerInterfaceSetupDataNative,
        },
        tests::test_client_server_sockets,
    };
    use datex_core::{
        network::com_interfaces::default_setup_data::tcp::{
            tcp_client::TCPClientInterfaceSetupData,
            tcp_server::TCPServerInterfaceSetupData,
        },
    ...
    async fn test_connect_and_communicate() {
        ...
        assert_eq!(client_interface_configuration.properties.channel, "tcp");
        assert_eq!(
        ...
        assert_eq!(server_interface_configuration.properties.channel, "tcp");
        assert_eq!(
